...
public class DBOperations {
	...
	public static boolean checkAdminDetails(Connection connection, String email, String password) throws SQLException {
		...
		if(isAdmin) { profile.add(email); profile.add(password); profile.add("admindetails"); }
		return isAdmin;
	}
	...
	public static boolean checkUserDetails(Connection connection, String email, String password) throws SQLException {
		...
		if(isUser) { profile.add(email); profile.add(password); profile.add("userdetails"); }
		return isUser;
	}
	
	// Insert Watches
	public static void insertNewWatch(Connection connection, String name, String brand, double price, String description,int number_of_stocks) throws SQLException {
	...
	// Update Watches
	public static void updateWatch(Connection connection, String sName, String brand, double price, String desc, int nOS, int wId) throws SQLException {
...
//		return res;
	...
	public static void insertUserDetails(Connection connection, String userName, String mobileNumber, String email, String address, String passCode) throws SQLException{
	...
	// Specific Detail about Watch is to Cearly mention the required watch for the user
			...
			while (resultSet.next()) {	
	            ...
	            int number_of_stocks = resultSet.getInt("number_of_stocks");
		            if(number_of_stocks!=0 && k==0) {	            	
		            	UserInterface.displayWatches(id, name, brand, price, description, number_of_stocks);
		            }
		            else {
	...
	public static void updateProfile(Connection connection, String name, String mobileNumber, String emailId, String address) throws SQLException {
